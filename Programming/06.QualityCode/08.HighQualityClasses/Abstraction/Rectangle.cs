...
namespace Abstraction
{
    ...
    public class Rectangle : Figure
    {
        ...
        /// <exception cref="ArgumentException">Thrown when <paramref name="Width"/> or <paramref name="Height"/> are zero or a negative value.</exception> 
        ...
        public double Width
        {
            ...
            set
            {
                if (value <= 0)
                {
                    throw new ArgumentException("Rectangle width can't be equal to zero or be of negative value!");
                }
        ...
        public double Height
        {
            ...
            set
            {
                if (value <= 0)
                {
                    throw new ArgumentException("Rectangle height can't be equal to zero or be of negative value!");
                }
