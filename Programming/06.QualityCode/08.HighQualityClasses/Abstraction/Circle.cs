...
namespace Abstraction
{
    ...
    public class Circle : Figure
    {
        ...
        /// <exception cref="ArgumentException">Thrown when <paramref name="radius"/> is zero or a negative value.</exception>
        ...
        public double Radius
        {
            ...
            set
            {
                if (value <= 0)
                {
                    throw new ArgumentException("Circle radius can't be equal to zero or be of negative value!");
                }
