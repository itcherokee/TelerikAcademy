...
/// starting at given index. Using it write another method that sorts an array in ascending / 
/// descending order."
/// </summary>
public class ReturnMaximalElement
{
    ...
    // Finds maximal number in and array starting from index
    ...
    // Sorts array in requested direction (ascending/descenting)
    public static void SortArray(ref int[] numbers, bool sortDirection)
    {
        ...
        {
            int biggestIndex = Array.IndexOf(numbers, FindMaximal(numbers, 0));
