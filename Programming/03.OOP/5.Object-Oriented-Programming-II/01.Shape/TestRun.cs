// Task 1:  Define abstract class Shape with only one abstract method CalculateSurface() and fields width and height.
...
//          CalculateSurface() method. Write a program that tests the behavior of  the CalculateSurface() method 
...
namespace MyShape
{
    ...
    public class TestRun
    {
        public static void Main()
        {
            ...
            {
                Console.WriteLine("Shape {0} has area of {1:F2} sq.sm", item.GetType().Name, item.CalculateSurface());
            }
        }
    }
}