...
{
    private static ConsoleColor[] deckColor = new ConsoleColor[4] { ConsoleColor.Black, ConsoleColor.Red, ConsoleColor.Red, ConsoleColor.Black };
    private static char[] symbol = new char[4] { '\u2660', '\u2665', '\u2666', '\u2663' };
    private static string[] suits = new string[4] { "spades", "hearts", "diamonds", "clubs" };
    private static string[,] cards = new string[13, 2] 
                                        {
